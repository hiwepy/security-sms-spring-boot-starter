...
public class IdentityCodeAuthenticationEntryPoint extends LoginUrlAuthenticationEntryPoint {

	public IdentityCodeAuthenticationEntryPoint(String loginFormUrl) {
		super(loginFormUrl);
	}
