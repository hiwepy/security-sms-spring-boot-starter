...
/**
 * Authentication provider for Sms authentication.
...
public class SmsAuthenticationProvider implements AuthenticationProvider {
    ...
    /**
     * Constructs a new sms authentication provider instance.
     *
     * @param userDetailsService the user details service
     * @param passwordEncoder the password encoder
     */
    public SmsAuthenticationProvider(final UserDetailsServiceAdapter userDetailsService, final PasswordEncoder passwordEncoder) {
     ...
     * @author <a href="https://github.com/loong10k">Loong Wan</a>
     * @param authentication  {@link SmsAuthenticationToken IdentityCodeAuthenticationToken} 对象
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        SmsAuthenticationToken authenticationToken = null;
        if(SecurityPrincipal.class.isAssignableFrom(ud.getClass())) {
        	authenticationToken = new SmsAuthenticationToken(ud, ud.getPassword(), ud.getAuthorities());        	
        } else {
        	authenticationToken = new SmsAuthenticationToken(ud.getUsername(), ud.getPassword(), ud.getAuthorities());
		}
