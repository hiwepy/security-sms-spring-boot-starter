 ...
 * Post认证请求失败后的处理实现
 */
public class IdentityCodeAuthenticationFailureHandler extends ExceptionMappingAuthenticationFailureHandler {

	private List<AuthenticationListener> authenticationListeners;
	
	public IdentityCodeAuthenticationFailureHandler(String defaultFailureUrl) {
		this.setDefaultFailureUrl(defaultFailureUrl);
	}
	
	public IdentityCodeAuthenticationFailureHandler(List<AuthenticationListener> authenticationListeners, String defaultFailureUrl) {
